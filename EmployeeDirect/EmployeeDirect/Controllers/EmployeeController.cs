...
namespace EmployeeDirect.Controllers
{
    ...
    public class EmployeeController : ControllerBase
    {
        ...
        {
            _logger.LogInformation($"Received PUT request for employee ID: {id}");
            
            if (id != employee.EmployeeID)
            {
                _logger.LogWarning($"Employee ID mismatch: URL ID {id} vs. Body ID {employee.EmployeeID}");
            ...
            try
            {
                ...
                _logger.LogInformation($"Updating employee: {existingEmployee.FirstName} {existingEmployee.LastName} (ID: {id})");
                ...
                _logger.LogInformation($"Update completed for employee ID {id}. Rows affected: {rowsAffected}");
